<template>
	...
	<div class="contact_us_6" style="margin-top: 15vh;">
				...
				<div class="container-block form-wrapper">
					...
					<div class="responsive-container-block" id="i2cbk">
						...
						<div class="responsive-cell-block wk-tab-12 wk-mobile-12 wk-desk-12 wk-ipadp-12" id="ip1yp">
							...
							<input class="input" id="ipmgh-3" name="Email" placeholder="Entrez votre email...">
						</div>
						<div class="responsive-cell-block wk-tab-12 wk-mobile-12 wk-desk-12 wk-ipadp-12" id="ih9wi">
							<p class="text-blk input-title">
								OBJET
							</p>
							<input class="input" id="imgis-3" name="objet" placeholder="Entrez votre objet...">
						</div>
						<div class="responsive-cell-block wk-tab-12 wk-mobile-12 wk-desk-12 wk-ipadp-12" id="i634i-3">
							<p class="text-blk input-title">
								MESSAGE
							</p>
							<textarea class="textinput" id="i5vyy-3" placeholder="Entrez votre message..."></textarea>
						</div>
					</div>
    ...
    class="grid max-w-screen-xl grid-cols-1 gap-8 px-8 py-16 mx-auto rounded-lg md:grid-cols-2 md:px-12 lg:px-16 xl:px-32 dark:bg-orange-100 dark:text-orange-800">
		...
		<form class="space-y-6">
            ...
            <div>
				<label for="objet" class="text-sm">Objet</label>
				<input id="objet" type="objet" class="w-full p-3 rounded dark:bg-gray-100">
			</div>
			<div>
