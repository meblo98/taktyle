          ...
          <div class=" relative ">
            ...
            <div class="lg:max-w-xl lg:pr-5 relative z-40">
              <h2
                ...
                <span
                  class="my-1 inline-block border-b-8 border-g4 bg-white px-4 font-bold text-g4 animate__animated animate__flash">
                  Boostez votre entreprise avec des outils digitaux
                  modernes</span>
              </h2>
              <p class="text-base text-gray-700">Des solutions adaptées aux PME en Afrique de l'Ouest.</p>
              <div class="mt-10 flex flex-col items-center md:flex-row">
                <a href="/contact"
                  class="mb-3 inline-flex h-12 w-50 me-3 items-center justify-center rounded bg-orange-600 p-0 font-medium tracking-wide text-white shadow-md transition hover:bg-blue-800 focus:outline-none md:mr-4 md:mb-0 md:w-auto">
                  Contactez-nous</a>
                <a href="/solution" aria-label="" class="group inline-flex mx-3 items-center font-semibold text-g1">Découvrez
                  nos solutions
                  <svg xmlns="http://www.w3.org/2000/svg"
                    class="ml-4 h-6 w-6 transition-transform group-hover:translate-x-2 mx-2" fill="none"
