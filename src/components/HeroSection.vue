...
<template>
  <!-- hero section -->
  <section class="relative mt-5 py-32 lg:py-36 bg-white">
    <div class="mx-auto lg:max-w-7xl w-full px-5 sm:px-10 md:px-12 lg:px-5 flex flex-col lg:flex-row gap-10 lg:gap-12">
      <div class="absolute w-full lg:w-1/2 inset-y-0 lg:right-0 hidden lg:block">
        ...
        <span class="absolute right-4 bottom-12 w-24 h-24 rounded-3xl bg-oange-600 blur-xl opacity-80"></span>
      </div>
      <span
    ...
    font-bold text-gray-900">
          Boostez votre <span
            class="text-transparent bg-clip-text bg-gradient-to-br from-indigo-600 from-20% via-blue-600 via-30% to-green-600">entreprise</span>
      ...
      <div class="flex flex-1 lg:w-1/2 lg:h-auto relative lg:max-w-none lg:mx-0 mx-auto max-w-3xl">
        <img src="@/assets/Images/hero.webp" alt="Hero image" width="2350" height="2359"
