      ...
      <div class="relative mx-auto max-w-screen-xl px-4 py-32 sm:px-6 lg:flex lg:h-screen lg:items-center lg:px-8">
        <div class="max-w-xl text-center ltr:sm:text-left rtl:sm:text-right">
          <h1 class="text-3xl text-orange sm:text-5xl">
            <strong class="block font-extrabold text-blue-700"> Boostez votre entreprise avec des outils digitaux
              modernes </strong>
      ...
      <div class="container flex flex-col justify-center p-6 mx-auto sm:py-12 lg:py-24 lg:flex-row lg:justify-between">
        <div class="flex flex-col justify-center p-6 text-center rounded-sm lg:max-w-md xl:max-w-lg lg:text-left">
          ...
          <div class="flex flex-col space-y-4 sm:items-center sm:justify-center sm:flex-row sm:space-y-0 sm:space-x-4 lg:justify-start">
            <a rel="noopener noreferrer" href="#" class="px-8 py-3 text-lg font-semibold rounded dark:bg-blue-600 dark:text-gray-50">Suspendisse</a>
        ...
        <div class="flex items-center justify-center p-6 mt-8 lg:mt-0 h-72 sm:h-80 lg:h-96 xl:h-112 2xl:h-128">
          <img src="@/assets/Images/contact.png" alt="" class="object-contain h-72 sm:h-80 lg:h-96 xl:h-112 2xl:h-128">
        </div>
      </div>
    </section>
  </template> -->
         ...
         <div class="flex flex-col items-center justify-between lg:flex-row py-16">
             <div class=" relative ">
                 <div class=" absolute top-0 -left-48 z-0  opacity-50 ">
                     <img src="@/assets/Images/image core value taktyl labs.png" class="w-36 z-0  h-full    object-fill fill-y text-y   ">
                 </div>
                 <div class="lg:max-w-xl lg:pr-5 relative z-40">
                     <h2 class="mb-6 max-w-lg text-5xl font-light leading-snug tracking-tight text-g1 sm:text-7xl sm:leading-snug">
                         ...
                         <span class="my-1 inline-block border-b-8 border-g4 bg-white px-4 font-bold text-g4 animate__animated animate__flash"> Boostez votre entreprise avec des outils digitaux
                          modernes</span>
                     </h2>
                     <p class="text-base text-gray-700">Des solutions adaptées aux PME en Afrique de l'Ouest.</p>
                     <div class="mt-10 flex flex-col items-center md:flex-row">
                         <a href="/" class="mb-3 inline-flex h-12 w-50 me-3 items-center justify-center rounded bg-orange-600 p-0 font-medium tracking-wide text-white shadow-md transition hover:bg-blue-800 focus:outline-none md:mr-4 md:mb-0 md:w-auto">
                          Contactez-nous</a>
                         <a href="/" aria-label="" class="group inline-flex mx-3 items-center font-semibold text-g1">Découvrez nos solutions
                             <svg xmlns="http://www.w3.org/2000/svg" class="ml-4 h-6 w-6 transition-transform group-hover:translate-x-2 mx-2" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
             ...
             <div class="relative hidden lg:ml-32 lg:block lg:w-1/2">
                 ...
                 <div class="abg-orange-400 mx-auto w-fit overflow-hidden rounded-[6rem] rounded-br-none rounded-tl-none">
                      <img src="@/assets/Images/image core value taktyl labs.png">
                 </div>
             </div>
         </div>
     </div> 
